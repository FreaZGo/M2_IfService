...
public class CompteServiceLocator extends org.apache.axis.client.Service implements fr.uge.sw.banque.CompteService {
    ...
    public fr.uge.sw.banque.Compte getCompte() throws javax.xml.rpc.ServiceException {
    ...
    public fr.uge.sw.banque.Compte getCompte(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fr.uge.sw.banque.CompteSoapBindingStub _stub = new fr.uge.sw.banque.CompteSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fr.uge.sw.banque.Compte.class.isAssignableFrom(serviceEndpointInterface)) {
                fr.uge.sw.banque.CompteSoapBindingStub _stub = new fr.uge.sw.banque.CompteSoapBindingStub(new java.net.URL(Compte_address), this);
                _stub.setPortName(getCompteWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://banque.sw.uge.fr", "CompteService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://banque.sw.uge.fr", "Compte"));
        }
